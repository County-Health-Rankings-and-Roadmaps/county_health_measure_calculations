---
title: "NCHS v161 Suicide (subgroups) - R2025"
...
## Census pop data by race and age cat 1-10 for 2018-2022

```{r}
pop_agecat_1_10 <- bind_rows(
  process_pop_v161_other(2018),
  process_pop_v161_other(2019),
  process_pop_v161_other(2020), 
  process_pop_v161_other(2021),
  process_pop_v161_other(2022) %>% 
    fix_CT_pop(process_pop_v161_other(2021))
  ) %>% 
...
- Note: pop for age_cat 0 and 1 may not be needed, as no case of suisides was found in the mortality data. This step is included to be consistent with other calculations.
...
```{r}
mort_all <- bind_rows(
  process_mort_v161_other(2018, icd_v161 = icd_code_lst), 
  process_mort_v161_other(2019, icd_v161 = icd_code_lst),
