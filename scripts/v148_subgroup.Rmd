---
title: "v148 Firearm Fatalities (subgroups) - R2025"
author: "GL"
...
```{r}
icd_code_lst <- c('W32','W33','W34','X72','X73','X74','X93','X94','X95','Y22','Y23','Y24', 'Y350')
...
```{r}
v148_other <- process_race_data_wide(v148_2, fips, "v148") %>% 
...
```{r}
v148_other_2 <- v148_other %>%
  add_flag_CT(vnum="v148_race", old = "U", new = "A")

```

# save data
```{r}
save_data(v148_other_2, "v148_otherdata")
```
